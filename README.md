...
## Overview
Hand written digit recognition using Logistic Regression, kernel SVM, Deep Neural Network (Lenet-5 architecture) with PCA or LDA dimensionality reduction for MINST dataset.
